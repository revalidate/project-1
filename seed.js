...
newsOrgs.push({
             ...
             review: [
               {date: Date.now(), score: 5, comment: "non biased news, no back end agenda"},
               {date: Date.now(), score: 4, comment: ""},
               {date: Date.now(), score: 4, comment: ""},
               {date: Date.now(), score: 4, comment: ""}
             ]
           });
...
newsOrgs.push({
             ...
             review: [
             {date: Date.now(), score: 4, comment: "democratic agenda but much more reliable than fox"},
             {date: Date.now(), score: 3, comment: ""}
             ]
           });
newsOrgs.push({
             ...
             review: [
                {date: Date.now(), score: 2, comment: "been around for decades so I trust the brand"},
                {date: Date.now(), score: 5, comment: "only news org that is more trusted than distrusted across all ideological groups"},
                {date: Date.now(), score: 3, comment: ""}
             ]
           });
newsOrgs.push({
...
newsOrgs.push({
             ...
             review: [
                {date: Date.now(), score: 2, comment: "again non biased, focus on equalized world news, equally focused on all parts of the world rather than just first world countries, trustworthy brand"},
                {date: Date.now(), score: 5, comment: ""},
                {date: Date.now(), score: 3, comment: ""}
             ]
           });
newsOrgs.push({
             ...
             review: [
                {date: Date.now(), score: 3, comment: "great trendy pieces and varied opinion pieces"},
                {date: Date.now(), score: 3, comment: "lots of dumb articles but all over fb"}
             ]
           });
newsOrgs.push({
             name: 'VICE',
             ...
             {date: Date.now(), score: 4, comment: "more emphasis on entertainment"},
             {date: Date.now(), score: 4, comment: ""}
             ]
           });
newsOrgs.push({
             ...
             review: [
             {date: Date.now(), score: 0, comment: "shit"},
             {date: Date.now(), score: 1, comment: "republican agenda absolute ass"},
             {date: Date.now(), score: 0, comment: ""}
             ]
           });
newsOrgs.push({
             name: 'NBC News',
             ...
             review: [
             {date: Date.now(), score: 0, comment: "biased"},
             {date: Date.now(), score: 2, comment: ""}
             ]
           });
newsOrgs.push({
             name: 'Times of India',
             ...
             review: [
             {date: Date.now(), score: 0, comment: "sensationalized entertainment disguised as news, the voice of the news screams for attention, which tells me that the substance is low"}
             ]
           });
newsOrgs.push({
             name: 'Yahoo! News',
             ...
             review: [
             {date: Date.now(), score: 2, comment: "varied news, it's okay, nothing special"},
             {date: Date.now(), score: 1, comment: ""},
             {date: Date.now(), score: 3, comment: ""}
             ]
           });
